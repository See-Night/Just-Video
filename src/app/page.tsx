    ...
    render(): React.ReactNode {
        return (
            <div className='w-screen h-screen'>
                <VideoPlayer />
                {/* <div className={`w-screen h-screen fixed top-0 left-0 z-20 flex justify-center items-center bg-black opacity-50 ${this.state.src == "" ? "" : "hidden"}`} id='mask' onDragOver={e => e.preventDefault()} onDrop={this.fileDropIn}>
                </div> */}
            </div>
        )
    }
